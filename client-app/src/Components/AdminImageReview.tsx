...
const AdminImageReview: React.FC = () => {
    ...
    const toReviewCard = (d: DonatedItem): ReviewCard => {
        ...
        const fallback =
            d.imagePath && d.imagePath.startsWith('http') ? d.imagePath : null;
            ...
            const withTags = res.data
                .filter(
                    item =>
                        ...
                        Array.isArray(item.analysisMetadata.tags),
                )
                .map(toReviewCard);
                    ...
                    <div className="tags-section">
                        ...
                        {selectedItem.analysisMetadata?.tags?.length ? (
                            <div className="tags-list">
                                {selectedItem.analysisMetadata.tags!.map(
                                    (tag, i) => (
                                        <div
                                            key={i}
